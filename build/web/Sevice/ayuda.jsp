...
<body>
    ...
    <section  class="cont-ayuda">
        <div class="docs">
            <div class="manual">
                <h2>Manual</h2>
                <p>AquÃ­ podrÃ¡ encontrar el manual de uso de nuestro sistema. PodrÃ¡ guiarle atravez de las diferentes opciones y herramientas que le brindamos.</p>
            </div>
    
            <div class="document">
                <h2>DocumentaciÃ³n</h2>
                <p>AquÃ­ se detallarÃ¡n mÃ¡s los procesos y herramientas que se realiza el sistema. AdemÃ¡s se mostrarÃ¡n las diferentes herramientas que se usaron para el desarrollo del sistema (NO INCLUYE EL CÃDIGO FUENTE).</p>
            </div> 
        </div>
        ...
        <div class="foro">
            ...
            <form>
                <fieldset>
                    <div class="asunto">
                        <label>Asunto:</label>
                        <input class="inpt-asunto" type="text">
                    </div>
            ...
            <div class="preg-foro">
                <div class="example">
                    <div>
                        <img src="../Recursos/icons/user_test.png">
                    </div>
                    <div class="preg">
                        <p class="preg-asunt">Asunto ejemplo 1</p>
                        <p class="preg-descr">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis error quo id quasi, provident adipisci libero neque ad sapiente enim amet  accusantium. Iste officiis quis tempora quae aperiam itaque molestiae.</p>
                    </div>
                </div>
                ...
                <div class="example">
                    ...
                    <div class="preg">
                        <p class="preg-asunt">Asunto ejemplo 2</p>
                        <p class="preg-descr">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis error quo id quasi, provident adipisci libero neque ad sapiente enim amet accusantium. Iste officiis quis tempora quae aperiam itaque molestiae.Lorem ipsum dolor sit amet consectetur adipisicing elit. Nobis error quo id quasi, provident adipisci libero neque ad sapiente enim amet accusantium. Iste officiis quis tempora quae aperiam itaque molestiae.</p>
                    </div>
                </div>
            </div>
        </div>
